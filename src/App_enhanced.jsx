    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-x-hidden">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <motion.a 
                ...
                whileHover={{ scale: 1.1, color: "rgb(var(--primary))" }}
                whileTap={{ scale: 0.95 }}
              >
                Features
              </motion.a>
      ...
      <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden min-h-screen flex items-center">
        ...
        >
          ...
          <motion.div
            className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.2, 1],
              rotate: [0, 180, 360],
              x: [0, 100, 0],
          ...
          >
            ...
            >
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Button size="lg" className="text-lg px-10 py-4 bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-600/90 shadow-lg">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Visualize your coding journey with GitHub-style contribution graphs and detailed analytics
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Get real-time insights into your code quality, performance, and team productivity with our advanced AI analytics dashboard
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary via-blue-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Join thousands of developers who are already coding smarter with DevCollab. 
            Start your free trial today and experience the future of collaborative development.
          </motion.p>
          <motion.div 
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button size="lg" variant="secondary" className="text-lg px-10 py-4 bg-white text-primary hover:bg-white/90">
                <Github className="mr-3 h-6 w-6" />
                Start Free Trial
                <motion.div
                  animate={{ x: [0, 5, 0] }}
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button size="lg" variant="outline" className="text-lg px-10 py-4 border-2 border-white text-white hover:bg-white/10">
                <Play className="mr-3 h-5 w-5" />
                Schedule Demo
              </Button>
            </motion.div>
